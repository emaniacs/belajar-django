...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Menu.link'
        db.add_column(u'products_menu', 'link',
                      self.gf('django.db.models.fields.CharField')(default='/', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Menu.link'
        db.delete_column(u'products_menu', 'link')
    ...
    models = {
        ...
        u'products.menu': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'nama': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
